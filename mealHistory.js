export const mealHistory = [
    {
        id: 100,
        title: 'Bizarre Style: Fashion In Jojo',
    ...
    {
        id: 300,
        title: 'SPIDER-MAN: BRAND NEW DAY TRAILER REACTION AND BREAKDOWN – THIS LOOKS AMAZING',
    ...
    {
        id: 400,
        title: 'Young Dabo Meets Burberry Erry!',
    ...
    {
        id: 500,
        title: 'BEFORE SATAN FELL…THIS HAPPENED! FULL MOVIE! 😲',
        channel: 'BIBLE DUDE',
        views: '893k views',
        duration: '43 min',
    ...
    {
        id: 600,
        title: '#UFC317 Pelea Gratis: Topuria vs Holloway',
        channel: 'ufcespanol',
        views: '15M views',
        duration: '16 min',
    ...
    {
        id: 700,
        title: 'FRAGMENTS | Short Film | Blender',
